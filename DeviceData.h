...
typedef struct {
  //TMemoryRange MemoryRange;
  TMemoryRange ranges[MAX_MEMORY_RANGES]; // size is a SWAG
  unsigned int RangeCount;
} TDeviceData;

extern void MemoryRange_construct(TMemoryRange * PRange);
extern void DeviceData_construct(TDeviceData * PDeviceData);
extern void DeviceData_destruct(TDeviceData * PDeviceData);
extern void DeviceData_clearranges(TDeviceData * PDeviceData);
extern void DeviceData_addrange(TDeviceData * PDeviceData, TMemoryRange * newrange);
